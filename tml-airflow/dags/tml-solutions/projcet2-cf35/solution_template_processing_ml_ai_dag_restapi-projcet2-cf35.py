...
step1 = importlib.import_module("tml-solutions.projcet2-cf35.tml_system_step_1_getparams_dag-projcet2-cf35")
step2 = importlib.import_module("tml-solutions.projcet2-cf35.tml_system_step_2_kafka_createtopic_dag-projcet2-cf35")
step3 = importlib.import_module("tml-solutions.projcet2-cf35.tml_read_RESTAPI_step_3_kafka_producetotopic_dag-projcet2-cf35")
step4 = importlib.import_module("tml-solutions.projcet2-cf35.tml_system_step_4_kafka_preprocess_dag-projcet2-cf35")
step5 = importlib.import_module("tml-solutions.projcet2-cf35.tml_system_step_5_kafka_machine_learning_dag-projcet2-cf35")
step6 = importlib.import_module("tml-solutions.projcet2-cf35.tml_system_step_6_kafka_predictions_dag-projcet2-cf35")
step7 = importlib.import_module("tml-solutions.projcet2-cf35.tml_system_step_7_kafka_visualization_dag-projcet2-cf35")
step8 = importlib.import_module("tml-solutions.projcet2-cf35.tml_system_step_8_deploy_solution_to_docker_dag-projcet2-cf35")
step9 = importlib.import_module("tml-solutions.projcet2-cf35.tml_system_step_9_privategpt_qdrant_dag-projcet2-cf35")
step10 = importlib.import_module("tml-solutions.projcet2-cf35.tml_system_step_10_documentation_dag-projcet2-cf35")


with DAG(
    dag_id="solution_preprocessing_ml_ai_restapi_dag-projcet2-cf35",
