...
default_args = {
 ...
 'solutionname': 'secproject2-cf35',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
...
@dag(dag_id="tml_system_step_1_getparams_dag_secproject2-cf35", default_args=default_args, tags=["tml_system_step_1_getparams_dag_secproject2-cf35"], schedule=None, catchup=False)
def tmlparams():
    # Define tasks
    def empty():
        pass
